...
namespace Beamable.Server.Clients
{
    ...
    public sealed class GPWDataServiceClient : MicroserviceClient
    {
        
        public GPWDataServiceClient(BeamContext context = null) : 
                base(context)
        {
        }
    ...
    internal sealed class MicroserviceParametersGPWDataServiceClient
    {
        
        [System.SerializableAttribute()]
        internal sealed class ParameterSystem_Collections_Generic_List_Beamable_Samples_GPW_Data_LocationData : MicroserviceClientDataWrapper<System.Collections.Generic.List<Beamable.Samples.GPW.Data.LocationData>>
        {
        }
        
        [System.SerializableAttribute()]
        internal sealed class ParameterSystem_Collections_Generic_List_Beamable_Samples_GPW_Data_ProductData : MicroserviceClientDataWrapper<System.Collections.Generic.List<Beamable.Samples.GPW.Data.ProductData>>
        {
        }
    }
    
    [BeamContextSystemAttribute()]
    public static class ExtensionsForGPWDataServiceClient
    {
        
        [Beamable.Common.Dependencies.RegisterBeamableDependenciesAttribute()]
        public static void RegisterService(Beamable.Common.Dependencies.IDependencyBuilder builder)
        {
            builder.AddScoped<GPWDataServiceClient>();
        }
        
        public static GPWDataServiceClient GPWDataService(this Beamable.Server.MicroserviceClients clients)
        {
            return clients.GetClient<GPWDataServiceClient>();
        }
    }
}
